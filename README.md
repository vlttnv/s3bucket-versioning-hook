# Vlttnv::S3BucketVersioningEnabled::Hook

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `vlttnv-s3bucketversioningenabled-hook.json`
2. Implement your resource handlers in `vlttnv_s3bucketversioningenabled_hook/handlers.py`
