...
def pre_create_handler(
    ...
    LOG.info("(Create) Internal testing hook triggered for target: " + request.hookContext.targetName);
...
def pre_update_handler(
    ...
    LOG.setLevel(logging.INFO)
    LOG.info("(Update) Internal testing hook triggered for target: " + request.hookContext.targetName);
